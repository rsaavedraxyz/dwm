...
static const char *fonts[]          = { "mono:size=9", "DejaVuSansMono Nerd Font Mono:size=18:style=bold:antialias=true:autohint=true"};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Return, spawn,          SHCMD("st -c 'floating' -g '100x25+0+0'") },
	...
	{ 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("change-volume +5 unmute && pkill -RTMIN+10 dwmblocks") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("change-volume -5 unmute && pkill -RTMIN+10 dwmblocks") },
	...
	{ 0,                            XF86XK_WebCam,	spawn, SHCMD("mpv av://v4l2:/dev/video0 --x11-name='webcam' --script-opts=osc-visibility=never --profile=low-latency --untimed --vf=hflip --screenshot-directory=$HOME/Pictures/Screenshots") },
